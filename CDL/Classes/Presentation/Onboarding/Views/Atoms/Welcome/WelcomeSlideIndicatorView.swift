...
private extension WelcomeSlideIndicatorView {
    ...
    func update() {
        indicator1View.backgroundColor = UIColor(integralRed: 245, green: 245, blue: 245, alpha: index == 1 ? 1 : 0.2)
        indicator2View.backgroundColor = UIColor(integralRed: 245, green: 245, blue: 245, alpha: index == 2 ? 1 : 0.2)
        indicator3View.backgroundColor = UIColor(integralRed: 245, green: 245, blue: 245, alpha: index == 3 ? 1 : 0.2)
