...
final class OldTestViewController: UIViewController {
...
// MARK: Make
extension OldTestViewController {
    static func make(testTypes: [TestType], activeSubscription: Bool, courseId: Int) -> OldTestViewController {
        let controller = OldTestViewController()
...
// MARK: Private
private extension OldTestViewController {
